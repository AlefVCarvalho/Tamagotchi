...
class TamagotchiApp:
    ...
    def create_side_panel(self):
        ...
        self.status_frame = tk.Frame(self.side_frame, bg="#f2f2f2")
        ...
        separator_pets = tk.Frame(self.side_frame, height=2, bg="#cccccc")
        separator_pets.pack(fill="x", pady=8)

        self.create_pet_selector()

        separator = tk.Frame(self.side_frame, height=2, bg="#cccccc")
        separator.pack(fill="x", pady=10)

        self.create_action_buttons()

        separator_2 = tk.Frame(self.side_frame, height=2, bg="#cccccc")
        separator_2.pack(fill="x", pady=10)

        self.create_scenario_buttons()
    ...
    def create_action_buttons(self):
        ...
        button_grid = tk.Frame(self.side_frame, bg="#f2f2f2")
        button_grid.pack()
    ...
    def create_scenario_buttons(self):
        ...
        scenario_label.pack(pady=3)

        scenario_grid = tk.Frame(self.side_frame, bg="#f2f2f2")
        scenario_grid.pack()
    ...
    def create_pet_selector(self):
        ...
        selector_grid = tk.Frame(self.side_frame, bg="#f2f2f2")
        selector_grid.pack()
